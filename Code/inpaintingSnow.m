...
sigma=1e-2; itMax=40; sigmaIterative=5e-6;
...
%for iFrame=1:lengthNFrame_
    ...
    subplot(2,2,3)
    imshow(RecoveredImage, [-1,256]);
    filename=['../Results/InpaintingSnowN',num2str(N),'.fig'];
    %savefig(filename);
...
filename=['../Results/InpaintingSnowN',num2str(N),'.mat'];
